...
namespace FEMur.Components.Model
{
    public class GH_Material : GH_Component
    {
        ...
        {
            pManager.AddNumberParameter("Young's Modulus", "E", "Young's Modulus of the material", GH_ParamAccess.item);
            pManager.AddNumberParameter("Poisson's Ratio", "v", "Poisson's Ratio of the material", GH_ParamAccess.item);
