...
namespace FEMur.Solver.Tests
{
    ...
    public class LinearStaticSolverTests
    {
        ...
        public void SolveTest()
        {
            ...
            Node node2 = new Node(1, 10.0, 0.0, 0.0);//mm
            ...
            PointLoad load1 = new PointLoad(1,new Vector3(0.0,1.0,0.0),new Vector3(0.0,0.0,0.0),false);//N
            ...
            double tol = 1e-6;
            //節点2のY方向変位
            double expectedDisplacementY = -0.0195; //理論値 mm
            double DispY = disp[7]; //節点2のY方向変位成分
